...
public class SegInEachChar {
	...
	public static Bitmap[] Math(Bitmap oriBmp) {
		...
		Bitmap bitmap2 = Bitmap.createBitmap(W2 - W1 - 1, H,
				Bitmap.Config.ARGB_8888);
		int W3 = PlateNumberGroup.PlateXState[M + 3];
		Bitmap bitmap3 = Bitmap.createBitmap(W3 - W2 - 1, H,
				Bitmap.Config.ARGB_8888);
		int W4 = PlateNumberGroup.PlateXState[M + 4];
		Bitmap bitmap4 = Bitmap.createBitmap(W4 - W3 - 1, H,
				Bitmap.Config.ARGB_8888);
		int W5 = PlateNumberGroup.PlateXState[M + 5];
		Bitmap bitmap5 = Bitmap.createBitmap(W5 - W4 - 1, H,
				Bitmap.Config.ARGB_8888);
		int W6 = PlateNumberGroup.PlateXState[M + 6];
		Bitmap bitmap6 = Bitmap.createBitmap(W6 - W5 - 1, H,
				Bitmap.Config.ARGB_8888);
		int W7 = PlateNumberGroup.PlateXState[M + 7];
		Bitmap bitmap7 = Bitmap.createBitmap(W7 - W6 - 1, H,
				Bitmap.Config.ARGB_8888);
		...
		return new Bitmap[] { bitmap1, bitmap2, bitmap3, bitmap4, bitmap5,
				bitmap6, bitmap7 };
	}
